<main>
    <section class="section-image section-home-one no-padding-y" style="background-image:url(http://via.placeholder.com/1920x1080)">
        <div class="container">
            <div class="row">
                <div class="col-lg-7">
                    <hr class="space-lg" />
                    ...
                    <ul class="slider" data-options="arrows:false,nav:false,autoplay:3000,controls:out">
                        <li>
                            <h1 class="text-uppercase">Technology to power your business</h1>
                        </li>
                        <li>
                            <h1 class="text-uppercase">Software to power your business</h1>
                        </li>
                        <li>
                            <h1 class="text-uppercase">Hardware to power your business</h1>
                        </li>
                    </ul>
                    <p>
...
<section class="section-video section-home-slider light">
  <!--<img src="media/ours/telematics.jpeg" />-->
        ...
        <div class="row">
            <div class="col-lg-7">
                <ul class="slider" data-options="type:slider,perView:1,arrows:true,nav:true,autoplay:3500" data-anima="fade-right" data-time="2000">
                    <li>
                        <h1>Software development, embedded systems and IOT</h1>
                        <a class="img-box" href="#">
                            <img src="media/ours/telematics.jpeg" alt="">
                        </a>
                    </li>
                    <li>
                        <h1>Telematics - CCTV & Monitoring</h1>
                        <a class="img-box" href="#">
                            <img src="media/ours/telematics.jpeg" alt="">
                        </a>
                    </li>
                    <li>
                        <h1>ICT Consultancy and Educational Services</h1>
                        <a class="img-box" href="#">
                            <img src="media/ours/telematics.jpeg" alt="">
                        </a>
                    </li>
            ...
            <div class="col-lg-5">
                <div class="row">
                    ...
                    <div class="col-lg-10" data-anima="fade-right" data-time="4000">
                        <!--<h2><span>Free</span> trial  </h2>-->
                        <!--<p>
                          In challenges we thrive.<br>
                          Create - Build - Develop = Solve;
                        </p>
